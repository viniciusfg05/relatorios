...
import { formatarDataBrasilia } from '../../utils/formatData';
  ...
  useEffect(() => {
    window.setRelatorioAuto = (dados) => {
      setPages(prevPages => {
        ...
        // Atualiza a primeira página (índice 0)
        if (newPages[0]) {
          newPages[0] = {
            ...newPages[0],
            titulo: dados.loja ? `PROPOSTA COMERCIAL – ${dados.loja}` : newPages[0].titulo,
            objeto: dados.servico ? `Encaminhamos o orçamento referente ${dados.servico}` : newPages[0].objeto,
            itens: dados.itens && dados.itens.length > 0 ? [...dados.itens] : newPages[0].itens,
          };
        }
        return newPages;
      });
      // Valor pode ser usado em uma página fixa, se necessário
        ...
        <div className="contentMain">
          ...
          <div className="editableText">
            ...
            <div style={{ marginTop: '3rem' }}>
              ...
              <span style={{ fontWeight: 'bold', fontSize: '1rem' }} contentEditable suppressContentEditableWarning
